...
class BankTranslator1 : IMessageComponent {
    ...
    override fun componentAction(msg: String) {
        ...
        val translatedXML = "<LoanRequest><ssn>" + requestObject.ssn + "</ssn><creditScore>" + requestObject.creditScore + "</creditScore><loanAmount>" + requestObject.amount + "</loanAmount><loanDuration>" + getDateString(Integer.parseInt(requestObject.duration)) + "</loanDuration></LoanRequest>"
    ...
    fun getDateString(months: Int): String{
        ...
        return years.toString() + "-" + if(months.toString().length == 2) "" else "0" + months.toString() + "-01 01:00:00.0 CET"
    }
...
class BankTranslator2 : IMessageComponent {
    ...
    override fun componentAction(msg: String) {
        ...
        // "Translation" going on here
        val requestObject = XMLParser(RequestObject::class.java).fromXML(msg)
        val translatedJSON = "{" + "\"ssn\":" + requestObject.ssn + "," + "\"creditScore\":" + requestObject.creditScore + "," + "\"loanAmount\":" + requestObject.amount + "," + "\"loanDuration\":" + requestObject.duration + "}"
